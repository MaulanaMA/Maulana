...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icon/1635989683_Logo saja UHW Perbanas (1).png"))); // NOI18N

        jLabel6.setFont(new java.awt.Font("Showcard Gothic", 1, 24)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(255, 255, 255));
        jLabel6.setText("KOS ON");
    ...
    private void LoginBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_LoginBtnActionPerformed
        ...
        SUrl = "jdbc:MySQL://localhost:3306/curd_app";
        SUser = "root";
        SPass = "";
        int notFound = 0;
        try {
...
public static void main(String[] args) {
        // Entry point code for your login functionality
        // For instance:
