...
public class kos extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        kos = new javax.swing.JTextField();
        ...
        jLabel9.setText("KOS-KOSAN");
        jPanel3.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 30, 140, -1));
        ...
        jLabel4.setText("Nam Kos");
        jPanel4.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 30, 100, 30));

        jLabel5.setFont(new java.awt.Font("Sylfaen", 1, 18)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(0, 102, 153));
        jLabel5.setText("Harga");
        jPanel4.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 180, 90, 30));
        jPanel4.add(harga, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 180, 270, 30));
        jPanel4.add(kos, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 30, 270, 30));

        address.setColumns(20);
        address.setRows(5);
        jScrollPane1.setViewportView(address);

        jPanel4.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 70, 270, -1));
        ...
        Table.setPreferredSize(new java.awt.Dimension(275, 120));
    ...
    public void loadData() {
       ...
       DefaultTableModel model = new DefaultTableModel(new String[]{"ID", "Nama Kos", "Harga","Address"}, 0);
      
       Table.setModel(model);
       String sql = "SELECT * FROM kos";
       
       ResultSet rs = (ResultSet) st.executeQuery(sql);
       String i,f,a,l;
       while(rs.next()){
         i = rs.getString("id");
         f = rs.getString("nama_kos");
         a = rs.getString("alamat");
         l = rs.getString("harga");
         model.addRow(new Object[]{i,f,a,l});
       }
     }catch(Exception e){
       ...
       try {
           ...
           if ("".equals(kos.getText())){
               ...
               JOptionPane.showMessageDialog(new JFrame(), "Address is require", "Dialog", 
                ...
                query = "INSERT INTO kos (nama_kos,harga, alamat)"
                       + "VALUES ('" + ks + "','" + hg + "','" + ad + "')";
        ...
        try {
            ...
            if("".equals(ID)){
              JOptionPane.showMessageDialog(new JFrame(), "ID is require", "Dialog",
               ...
               String sql = "SELECT * FROM kos WHERE id="+ID;
               ResultSet rs = st.executeQuery(sql);
               while(rs.next()){
                   kos.setText(rs.getString("nama_kos"));
            ...
            if("".equals(ID)){
              JOptionPane.showMessageDialog(new JFrame(), "ID is require", "Dialog",
               ...
               while(rs.next()){
                ...
                hg = harga.getText();
                ad = address.getText();
                String sql2 = "UPDATE kos SET nama_kos='"+ks+"', harga='"+hg+"',"
                        + "alamat='"+ad+"'  WHERE id="+ID;
        ...
        try {
            ...
            if("".equals(ID)){
              JOptionPane.showMessageDialog(new JFrame(), "ID is require", "Dialog",
               ...
               while(rs.next()){
                 notFound = 1;
                 String sql2 = "DELETE FROM kos WHERE id="+ID;
                 st.executeUpdate(sql2); 
                 loadData();
                 con.close();
               }
    ...
    private void cetakActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cetakActionPerformed
       ...
       try {
            String reportPath = "src/report/kos.jasper";
    ...
    private javax.swing.JTextField kos;
